...
7. Pokud NELZE z textu zprávy určit žádného odběratele ani po porovnání se ZNÁMÍ ODBĚRATELÉ, projdi nejdřív obecný vzorec v bodě 13 níže — teprve pak, pokud opravdu nic nenajdeš, vrať null.
...
11. PŘÍSNĚ ZAKÁZÁNO — NEVYMÝŠLEJ ODBĚRATELE: Nikdy nepoužívej jako place_name název ze seznamu ZNÁMÍ ODBĚRATELÉ, který se NEVYSKYTUJE v textu zprávy ani ve jméně odesílatele — to je vymýšlení a vede k objednávce u špatného zákazníka. (Tohle NENÍ v rozporu s bodem 13 — tam nejde o vymýšlení, ale o použití jména/místa, které v textu SKUTEČNĚ JE, jen nesedí přesně na žádného ze ZNÁMÍ ODBĚRATELÉ.)
12. MÍSTO/ADRESA JE TAKY ODBĚRATEL — NEVRACEJ null JEN PROTO, ŽE NÁZEV ZNÍ JAKO ADRESA NEBO MÍSTO KONÁNÍ: Tenhle pivovar běžně dováží i na jednorázové akce (svatby, hrady, zámky, sportoviště, soukromé pozemky) a takovou objednávku eviduje POD NÁZVEM TOHO MÍSTA/AKCE — to je odběratel, i když zní jako adresa, ne jako firma nebo hospoda. Pokud zpráva používá vzorec "na [místo]", "pro [místo]" nebo "do [místo]" (viz bod 3) a jiný kandidát na odběratele v textu není, POUŽIJ TO MÍSTO jako place_name — i kdyby to bylo jméno hradu, obce, ulice nebo jiné adresy. NEVRACEJ null jen z opatrnosti, že "místo není totéž co zákazník" — pro tenhle pivovar TOTÉŽ JE. PŘÍKLAD: "Na Vildstejn, Skalná\n2x30l 12sv\n2x30l tmava" → place_name = "Vildstejn, Skalná" (NE null — "Vildstejn, Skalná" je jméno hradu/obce a zároveň jméno odběratele téhle objednávky).
13. OBECNÝ VZOREC — ODBĚRATEL JE TÉMĚŘ VŽDY NĚKDE V TEXTU, NEVZDÁVEJ SE NA null PŘEDČASNĚ: Než vrátíš place_name: null, projdi text ještě jednou a hledej JAKÉKOLIV jméno osoby, firmy, spolku, hospody nebo místa/akce, které v textu je a NENÍ to: název/stupeň piva (katalog), objem/obal ("10", "20", "30", "50", "l", "ks", "KEG", "PET", "lahev"...), datum/den, nebo obecné slovo/fráze ("prosím", "díky", "zítra", "dnes", "sklad", "vyzvedne", "faktura", "výdejka", "objednávka") a NENÍ to jméno odesílatele/zaměstnance pivovaru (viz body 2, 6). Typické vzorce, kde bývá schovaný:
   - "pro [jméno]", "od [jméno]", "u [jméno]" — i ŘETĚZENÉ, např. "pro Tomáše od Marušky" → CELÉ "Tomáš od Marušky" je jméno odběratele, NE jen samotné křestní jméno "Tomáš".
   - "na [místo/akci]", "do [místo]" — název akce nebo místa konání (svatba, lázně, hrad, sportoviště…), viz bod 12.
   - Vlastní jméno psané s velkým písmenem uprostřed věty, i mimo výše uvedené vzorce (např. "z Koruna", "u Kropfa").
   - Cokoliv, co zpráva zmiňuje jen jednou a na co se dá napojit celá objednávka, i když to není klasický název hospody/firmy a i když to neodpovídá ničemu ze ZNÁMÍ ODBĚRATELÉ.
   Pokud najdeš byť jen jedno takové slovo/frázi, POUŽIJ JI jako place_name. Teprve když text opravdu NEOBSAHUJE VŮBEC ŽÁDNÉ takové jméno/místo/frázi (např. zpráva je jen "3x30 12sv" bez jediného dalšího slova), vrať null. PŘÍKLAD: "Pro Tomase od Marusky z koruna na akci do Frantiskovych lazni prosim 3x50l jantar" → place_name = "Tomáš od Marušky" (hlavní odběratel je pojmenovaná osoba za "pro"; "z koruna" a "do Frantiskovych lazni" jsou jen doplňkové údaje o původu/místě akce, ne samotný odběratel).
...
- Pokud se zdá, že text žádného odběratele neobsahuje (a neříká "pro mě"/"mi"/"mně" — viz výjimka výše), NEJDŘÍV znovu projdi bod 13 výše (KRITICKÉ PRAVIDLO PRO ODBĚRATELE) — jméno/místo tam skoro vždy je, jen nemusí sedět na klasický formát "pro/na/do X". Teprve když opravdu nic nenajdeš, vrať place_name = null. NIKDY neodvozuj odběratele z JMÉNA ODESÍLATELE — ani tehdy, když je odesílatel mezi ZNÁMÍMI ODBĚRATELI, a ani tehdy, když to vypadá jako nejpravděpodobnější volba. Odesílatel je vždy jen posel (kromě výjimky "pro mě"). NIKDY nevybírej odběratele ze seznamu ZNÁMÍ ODBĚRATELÉ, který v textu vůbec není zmíněný — to je vymýšlení; ale jméno/místo, které V TEXTU SKUTEČNĚ JE, i když v seznamu ZNÁMÍ ODBĚRATELÉ není, použij (viz bod 13).
